          ...
          <div class="mb-3">
            ...
            <div class="row justify-content-start align-items-center">
              <div class="col-lg-4 col-md-4 col-sm-5 col-12">
                <img id="preview-image-before-upload" src="{{ asset('images/admin/'. $projek->foto) }}" alt="preview image" class="img-thumbnail mt-2 mb-3 w-100" data-toggle="modal" data-target="#modalFoto">
              </div>
